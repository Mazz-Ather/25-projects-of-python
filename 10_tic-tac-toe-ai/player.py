        ...
        while not valid_square:
            ...
            try:
                ...
                if val not in game.available_moves():
                    print(f"Position {val} is not available. Available moves: {game.available_moves()}")
                    raise ValueError
                valid_square = True # if these are suzccessful, then yay!
            except ValueError:
...
class GeniusComputerPlayer(Player):
    ...
    def minimax(self, state, player):
        ...
        other_player = 'O' if player == 'X' else 'X'  # the other player... who won?
